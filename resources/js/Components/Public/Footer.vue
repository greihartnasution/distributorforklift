...
const consultantCompany = computed(
    () => inquiry.value.consultant_company || "",
);
...
const consultantPhoto = computed(() => inquiry.value.consultant_photo || null);
            ...
            <div class="max-w-screen-xl mx-auto px-4">
                ...
                >
                    ...
                    <div>
                        ...
                        <div
                            v-if="consultantName"
                            class="flex items-start gap-3 mt-6 pt-6 border-t border-gray-100"
                        >
                            <div
                                class="shrink-0 flex flex-col items-center gap-2"
                            >
                                <img
                                    v-if="consultantPhoto"
                                    :src="consultantPhoto"
                                    :alt="consultantName"
                                ...
                                <div class="flex gap-1">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener"
                                        class="w-5 h-5 bg-slate-200 hover:bg-orange-600 flex items-center justify-center rounded-full transition-colors duration-200 group"
                                        title="Instagram"
                                    >
                                        <svg
                                            class="w-2.5 h-2.5 text-slate-500 group-hover:text-white"
                                            fill="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                            <path
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.19a8.27 8.27 0 004.84 1.55V6.29a4.85 4.85 0 01-1.07-.6z"
                                            />
                                        </svg>
                                    </a>
                                    <a
                            ...
                            <div class="min-w-0">
                                ...
                                <p
                                    v-if="consultantTitle"
                                    class="text-xs text-slate-500"
                                >
                                    {{ consultantTitle }}
                                </p>
                                <p
                                    v-if="consultantCompany"
                                    class="text-xs text-slate-400 mb-2"
                                >
                                    {{ consultantCompany }}
                                </p>
                                <a
                                    v-if="consultantPhone"
