...
function doDelete() {
    ...
    router.delete(route("admin.news.destroy", deleting.value.id), {
    ...
    <AuthenticatedLayout>
        ...
        >
            ...
            <p class="text-xs text-slate-400 mt-1">
                Tambahkan artikel pertama untuk ditampilkan di halaman berita.
            </p>
        </div>
                ...
                <table class="w-full text-sm min-w-[700px]">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/60">
                            <th
                                class="text-left text-xs font-semibold text-slate-500 uppercase tracking-wide px-5 py-3 w-10"
                            >
                                No
                            </th>
                            <th
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        >
                            ...
                            <td class="px-5 py-3.5 max-w-xs">
                                ...
                                <p
                                    class="font-semibold text-slate-800 leading-snug line-clamp-2"
                                >
                                    {{ article.title }}
                                </p>
            ...
            >
                ...
                <div class="flex items-center gap-1">
                    <a
                        ...
                        class="px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-orange-600 border border-gray-200 hover:border-orange-300 rounded transition-colors"
                    >
                        ← Sebelumnya
                    </a>
                    <a
        ...
        >
            <div class="bg-white rounded-lg shadow-xl w-full max-w-sm p-6">
                ...
                <p class="text-xs text-slate-500 text-center mb-5">
                    Artikel "<span class="font-semibold">{{
                        deleting.title
                    }}</span
