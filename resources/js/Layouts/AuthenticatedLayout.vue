...
const isCompanyProfileActive = computed(() => {
    try {
        return (
            ...
            route().current("admin.homepage.testimonials.index") ||
            route().current("admin.homepage.testimonials.create") ||
            route().current("admin.homepage.testimonials.edit") ||
            route().current("admin.homepage.clients.index") ||
            route().current("admin.homepage.clients.create") ||
            route().current("admin.homepage.clients.edit")
        );
    } catch {
        return false;
    }
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        ...
                        >
                            ...
                            <Link
                                :href="route('admin.homepage.testimonials.index')"
                                class="flex items-center gap-2.5 px-3 py-2 rounded-md font-medium transition-colors duration-150"
                                :class="
                                    isItemActive('admin.homepage.testimonials.index') ||
                                    isItemActive('admin.homepage.testimonials.create') ||
                                    isItemActive('admin.homepage.testimonials.edit')
                                        ? 'bg-orange-50 text-orange-600 font-semibold'
                                        : 'text-slate-500 hover:bg-gray-50 hover:text-slate-700'
                                "
                            >
                            ...
                            <Link
                                :href="route('admin.homepage.clients.index')"
                                class="flex items-center gap-2.5 px-3 py-2 rounded-md font-medium transition-colors duration-150"
                                :class="
                                    isItemActive('admin.homepage.clients.index') ||
                                    isItemActive('admin.homepage.clients.create') ||
                                    isItemActive('admin.homepage.clients.edit')
                                        ? 'bg-orange-50 text-orange-600 font-semibold'
                                        : 'text-slate-500 hover:bg-gray-50 hover:text-slate-700'
                                "
                            >
